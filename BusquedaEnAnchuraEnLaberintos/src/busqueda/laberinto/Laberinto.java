...
public class Laberinto {
    public static short OBSTACULO = -1;
    public static short VALOR_UBICACION_INICIO = -2;
    public static short VALOR_UBICACION_OBJETIVO = -3;
    private int alto = 0;
    private int ancho = 0;
    ...
    public Laberinto(int alto, int ancho) {
        ...
        /**
         * Se colocan obstaculos de forma aleatoria
         */
        int max_obstaculos = (ancho * alto) / 3;
        ...
        /**
         * Especifica la ubicación de inicio
         */
        ubicacionInicio.x = 0;
        ubicacionInicio.y = 0;
        setValor(0,0, (short)0);
        
        /**
         * Especifica la ubicacion objetivo
         */
        ubicacionObjetivo.x = ancho - 1;
        ubicacionObjetivo.y = alto -1;
        setValor(ancho - 1, alto - 1, VALOR_UBICACION_OBJETIVO);
    }
